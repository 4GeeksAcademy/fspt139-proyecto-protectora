...
class Request(db.Model):
    ...
    def serialize(self):
        ...
        return {
            ...
            "animal_story": self.animal.story if self.animal else None,
            "animal_status": self.animal.status if self.animal else None,
            "animal_cover_image": next((media.url for media in self.animal.media if media.is_cover), None) if self.animal else None,
            "status": self.status,
